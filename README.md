...
- [Cleanup](https://github.com/mohasinmudassar/retail-store-app-deployment/blob/main/README.md#step-12-cleanup)
...
3. **Clone Repository**: `git clone https://github.com/mohasinmudassar/retail-store-app-deployment`
...
1. **Install Prerequisites**: AWS CLI, Terraform, kubectl, Docker, Helm
2. **Configure AWS**: `aws configure` with appropriate credentials
3. **Clone Repository**: `git clone https://github.com/mohasinmudassar/retail-store-app-deployment.git`
4. **Deploy Infrastructure**: Run Terraform in two phases (see [Getting Started](#getting-started))
5. **Access Application**: Get load balancer URL and browse the retail store
...
```sh
git clone https://github.com/mohasinmudassar/retail-store-app-deployment.git
```
